...
# odroidx. It lists all the overlays, files, modules and properties
...
# Init files
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/conf/init.odroidx.rc:root/init.odroidx.rc \
	$(LOCAL_PATH)/conf/init.odroidx.usb.rc:root/init.odroidx.usb.rc \
	$(LOCAL_PATH)/conf/fstab.odroidx:root/fstab.odroidx \
    $(LOCAL_PATH)/conf/fstab.odroidx.sdboot:root/fstab.odroidx.sdboot
	
# For V4L2
ifeq ($(BOARD_USE_V4L2), true)
ifeq ($(BOARD_USE_V4L2_ION), true)
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/conf/ueventd.odroidx.v4l2ion.rc:root/ueventd.odroidx.rc
else
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/conf/ueventd.odroidx.v4l2.rc:root/ueventd.odroidx.rc
endif
else
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/conf/ueventd.odroidx.rc:root/ueventd.odroidx.rc
endif
...
PRODUCT_COPY_FILES += \
	device/hardkernel/odroidx/drivers/rt5370sta.ko:system/lib/modules/rt5370sta.ko \
	device/hardkernel/odroidx/drivers/rt5370sta.cal:system/etc/firmware/rt5370sta.cal 
...
#
PRODUCT_COPY_FILES += \
	device/hardkernel/odroidx/drivers/uvcvideo_x.ko:system/lib/modules/uvcvideo.ko
#
# sound card Module
#
PRODUCT_COPY_FILES += \
	device/hardkernel/odroidx/drivers/snd-usb-audio_x.ko:system/lib/modules/snd-usb-audio.ko \
	device/hardkernel/odroidx/drivers/snd-usbmidi-lib_x.ko:system/lib/modules/snd-usbmidi-lib.ko
